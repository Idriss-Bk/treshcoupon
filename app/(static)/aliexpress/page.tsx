    ...
    <div className='mb-16 px-5 md:px-0'>
        ...
        <div className="lg:w-7/12">
            ...
            <div className='text-sm text-zinc-800 mb-4 font-semibold'>
                ...
                <span className='inline-block text-black mr-2 underline'>Discounts from <strong>5% off</strong> to <strong>35% off</strong></span>
            </div>
        </div>
      </div>
      <div className='border-b-[1px] border-slate-200 mt-8 mb-8'></div>
        <div className='py-5 px-6 w-full shadow-md rounded-lg border-2 mb-5 border-slate-200'>
            <div className='flex justify-between items-center'>
                <div className='flex justify-center items-center gap-3'>
                    <div className=''>
                        <div className='mask mask-hexagon h-[100px] w-[100px] bg-slate-200 flex justify-center items-center flex-col'>
                            ...
                            <span className='text-sm text-black font-bold text-center -mt-[39px]'>50% OFF</span>
                        </div>
                    </div>
                ...
                <div className=''>
                    <button className='py-2.5 px-4 rounded-full bg-[#E43225] text-white font-semibold'><RiScissorsCutFill className='inline-block text-white text-lg relative -top-[0.5px] mr-[2px]' /> Get Coupon Code</button>
                </div>
            </div>
        </div>
        <div className='py-5 px-6 w-full shadow-md rounded-lg border-2 mb-5 border-slate-200'>
            <div className='flex justify-between items-center'>
                <div className='flex justify-center items-center gap-3'>
                    <div className=''>
                        <div className='mask mask-hexagon h-[100px] w-[100px] bg-slate-200 flex justify-center items-center flex-col'>
                            <SiAliexpress className="text-[#E43225] text-6xl relative -top-[15px]" />
                            <span className='text-sm text-black font-bold text-center -mt-[39px]'>$25 OFF</span>
                        </div>
                    </div>
                    <div className='flex justify-start items-start flex-col'>
            ...
            <div className='flex justify-between items-center'>
                <div className='flex justify-center items-center gap-3'>
                    <div className=''>
                        <div className='mask mask-hexagon h-[100px] w-[100px] bg-slate-200 flex justify-center items-center flex-col'>
                            <SiAliexpress className="text-[#E43225] text-6xl relative -top-[15px]" />
                            <span className='text-sm text-black font-bold text-center -mt-[39px]'>20% OFF</span>
                        </div>
                    </div>
                    <div className='flex justify-start items-start flex-col'>
            ...
            <div className='flex justify-between items-center'>
                <div className='flex justify-center items-center gap-3'>
                    <div className=''>
                        <div className='mask mask-hexagon h-[100px] w-[100px] bg-slate-200 flex justify-center items-center flex-col'>
                            <SiAliexpress className="text-[#E43225] text-6xl relative -top-[15px]" />
                            <span className='text-sm text-black font-bold text-center -mt-[39px]'>60% OFF</span>
                        </div>
                    </div>
                    <div className='flex justify-start items-start flex-col'>
            ...
            <div className='flex justify-between items-center'>
                <div className='flex justify-center items-center gap-3'>
                    <div className=''>
                        <div className='mask mask-hexagon h-[100px] w-[100px] bg-slate-200 flex justify-center items-center flex-col'>
                            <SiAliexpress className="text-[#E43225] text-6xl relative -top-[15px]" />
                            <span className='text-sm text-black font-bold text-center -mt-[39px]'>30% OFF</span>
                        </div>
                    </div>
                    <div className='flex justify-start items-start flex-col'>
